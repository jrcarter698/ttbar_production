...
#do i=1,14;
    #do j=1,14;
L Tr`i'`j'=g_(1,p1)*T1(1,`i',mu1,mu2,mu3)*g_(1,p2)*T1p(1,`j',nu1,nu2,nu3)*(g_(2,p3)+m)*T2(2,`i',mu1,mu2,mu3)*(g_(2,p4)-m)*T2p(2,`j',nu1,nu2,nu3);
    #enddo;
#enddo;
*
id T1(i?,1,mu1?,mu2?,mu3?)=g_(i,p3);
id T1(i?,2,mu1?,mu2?,mu3?)=g_(i,mu1);
id T1(i?,3,mu1?,mu2?,mu3?)=g_(i,p3);
id T1(i?,4,mu1?,mu2?,mu3?)=g_(i,mu1);
id T1(i?,5,mu1?,mu2?,mu3?)=g_(i,p3,mu1,mu2);
id T1(i?,6,mu1?,mu2?,mu3?)=g_(i,p3,mu1,mu2);
id T1(i?,7,mu1?,mu2?,mu3?)=g_(i,mu1,mu2,mu3);
id T1(i?,8,mu1?,mu2?,mu3?)=g_(i,5_,p3);
id T1(i?,9,mu1?,mu2?,mu3?)=g_(i,5_,mu1);
id T1(i?,10,mu1?,mu2?,mu3?)=g_(i,5_,p3);
id T1(i?,11,mu1?,mu2?,mu3?)=g_(i,5_,mu1);
id T1(i?,12,mu1?,mu2?,mu3?)=g_(i,5_,p3,mu1,mu2);
id T1(i?,13,mu1?,mu2?,mu3?)=g_(i,5_,p3,mu1,mu2);
id T1(i?,14,mu1?,mu2?,mu3?)=g_(i,5_,mu1,mu2,mu3);
*
id T1p(i?,1,mu1?,mu2?,mu3?)=g_(i,p3);
id T1p(i?,2,mu1?,mu2?,mu3?)=g_(i,mu1);
id T1p(i?,3,mu1?,mu2?,mu3?)=g_(i,p3);
id T1p(i?,4,mu1?,mu2?,mu3?)=g_(i,mu1);
id T1p(i?,5,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p3);
id T1p(i?,6,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p3);
id T1p(i?,7,mu1?,mu2?,mu3?)=g_(i,mu3,mu2,mu1);
id T1p(i?,8,mu1?,mu2?,mu3?)=g_(i,p3,5_);
id T1p(i?,9,mu1?,mu2?,mu3?)=g_(i,mu1,5_);
id T1p(i?,10,mu1?,mu2?,mu3?)=g_(i,p3,5_);
id T1p(i?,11,mu1?,mu2?,mu3?)=g_(i,mu1,5_);
id T1p(i?,12,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p3,5_);
id T1p(i?,13,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p3,5_);
id T1p(i?,14,mu1?,mu2?,mu3?)=g_(i,mu3,mu2,mu1,5_);
*
id T2(i?,1,mu1?,mu2?,mu3?)=1;
id T2(i?,2,mu1?,mu2?,mu3?)=g_(i,mu1);
id T2(i?,3,mu1?,mu2?,mu3?)=g_(i,p1);
id T2(i?,4,mu1?,mu2?,mu3?)=g_(i,p1,mu1);
id T2(i?,5,mu1?,mu2?,mu3?)=g_(i,mu1,mu2);
id T2(i?,6,mu1?,mu2?,mu3?)=g_(i,p1,mu1,mu2);
id T2(i?,7,mu1?,mu2?,mu3?)=g_(i,mu1,mu2,mu3);
id T2(i?,8,mu1?,mu2?,mu3?)=g_(i,5_);
id T2(i?,9,mu1?,mu2?,mu3?)=g_(i,5_,mu1);
id T2(i?,10,mu1?,mu2?,mu3?)=g_(i,5_,p1);
id T2(i?,11,mu1?,mu2?,mu3?)=g_(i,5_,p1,mu1);
id T2(i?,12,mu1?,mu2?,mu3?)=g_(i,5_,mu1,mu2);
id T2(i?,13,mu1?,mu2?,mu3?)=g_(i,5_,p1,mu1,mu2);
id T2(i?,14,mu1?,mu2?,mu3?)=g_(i,5_,mu1,mu2,mu3);
*
id T2p(i?,1,mu1?,mu2?,mu3?)=1;
id T2p(i?,2,mu1?,mu2?,mu3?)=g_(i,mu1);
id T2p(i?,3,mu1?,mu2?,mu3?)=g_(i,p1);
id T2p(i?,4,mu1?,mu2?,mu3?)=g_(i,mu1,p1);
id T2p(i?,5,mu1?,mu2?,mu3?)=g_(i,mu2,mu1);
id T2p(i?,6,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p1);
id T2p(i?,7,mu1?,mu2?,mu3?)=g_(i,mu3,mu2,mu1);
id T2p(i?,8,mu1?,mu2?,mu3?)=g_(i,5_);
id T2p(i?,9,mu1?,mu2?,mu3?)=g_(i,mu1,5_);
id T2p(i?,10,mu1?,mu2?,mu3?)=g_(i,p1,5_);
id T2p(i?,11,mu1?,mu2?,mu3?)=g_(i,mu1,p1,5_);
id T2p(i?,12,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,5_);
id T2p(i?,13,mu1?,mu2?,mu3?)=g_(i,mu2,mu1,p1,5_);
id T2p(i?,14,mu1?,mu2?,mu3?)=g_(i,mu3,mu2,mu1,5_);
*
