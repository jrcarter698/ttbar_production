...
id T(i?,9,k?,l?)=g_(i,k,l);
id T(i?,10,k?,l?)=p3(l)*g_(i,k,p1);
id Tp(i?,1,k?,l?)=d_(k,l);
id Tp(i?,2,k?,l?)=p3(k)*p3(l);
id Tp(i?,3,k?,l?)=d_(k,l)*g_(i,p1);
id Tp(i?,4,k?,l?)=p3(k)*p3(l)*g_(i,p1);
id Tp(i?,5,k?,l?)=p3(k)*g_(i,l);
id Tp(i?,6,k?,l?)=p3(l)*g_(i,k);
id Tp(i?,7,k?,l?)=g_(i,p1,l,k);
id Tp(i?,8,k?,l?)=p3(k)*g_(i,p1,l);
id Tp(i?,9,k?,l?)=g_(i,l,k);
id Tp(i?,10,k?,l?)=p3(l)*g_(i,p1,k);
*
