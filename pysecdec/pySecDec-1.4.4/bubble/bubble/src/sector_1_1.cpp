...
SecDecInternalSecondAbbreviation[1]=2.E+0*SecDecInternallogCall3 -SecDecInternallogCall1 - SecDecInternallogCall2;SecDecInternalSecondAbbreviation[1]=2.E+0*SecDecInternalSecDecInternalDenominatorCall1*SecDecInternalSecDecInternalCondefJacCall1*SecDecInternalSecondAbbreviation[1];
