...
#procedure insertDeformedIntegrationVariables
  ...
  Id dSecDecInternalDeformedx0d0(x0?,x1?) = ( + (1)) + ( + (1) * ( + (-I*SecDecInternalLambda0)) * ( + (1) + (-1)*x0) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd0( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda0)*x0) * ( + (-1)) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd0( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda0)*x0) * ( + (1) + (-1)*x0) * (SecDecInternalRealPart( + (1) * ( + (1)) * ( + (1) * ( + (1)) * (ddFd0d0( + (1)*x0, + (1)*x1, + (1)*eps))))));
  Id dSecDecInternalDeformedx0d1(x0?,x1?) = ( + (0)) + ( + (1) * ( + (0)) * ( + (1) + (-1)*x0) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd0( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda0)*x0) * ( + (0)) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd0( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda0)*x0) * ( + (1) + (-1)*x0) * (SecDecInternalRealPart( + (1) * ( + (1)) * ( + (1) * ( + (1)) * (ddFd0d1( + (1)*x0, + (1)*x1, + (1)*eps))))));
  Id SecDecInternalDeformedx1(x0?,x1?) = ( + (1)*x1) + (( + (-I*SecDecInternalLambda1)*x1) * ( + (1) + (-1)*x1) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd1( + (1)*x0, + (1)*x1, + (1)*eps)))));
  Id dSecDecInternalDeformedx1d0(x0?,x1?) = ( + (0)) + ( + (1) * ( + (0)) * ( + (1) + (-1)*x1) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd1( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda1)*x1) * ( + (0)) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd1( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda1)*x1) * ( + (1) + (-1)*x1) * (SecDecInternalRealPart( + (1) * ( + (1)) * ( + (1) * ( + (1)) * (ddFd0d1( + (1)*x0, + (1)*x1, + (1)*eps))))));
  Id dSecDecInternalDeformedx1d1(x0?,x1?) = ( + (1)) + ( + (1) * ( + (-I*SecDecInternalLambda1)) * ( + (1) + (-1)*x1) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd1( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda1)*x1) * ( + (-1)) * (SecDecInternalRealPart( + (1) * ( + (1)) * (dFd1( + (1)*x0, + (1)*x1, + (1)*eps)))) + (1) * ( + (-I*SecDecInternalLambda1)*x1) * ( + (1) + (-1)*x1) * (SecDecInternalRealPart( + (1) * ( + (1)) * ( + (1) * ( + (1)) * (ddFd1d1( + (1)*x0, + (1)*x1, + (1)*eps))))));
