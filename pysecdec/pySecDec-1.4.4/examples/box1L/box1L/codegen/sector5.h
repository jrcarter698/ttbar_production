...
#procedure insertDecomposed
  ...
  Id dFd1(x0?,x1?,x2?,eps?) =  + (-s) + (msq)*x0;
  Id F(x0?,x1?,x2?,eps?) =  + ( + (-s))*x1 + ( + (msq - s1)) + ( + (msq - t))*x2 + ( + (msq))*x0*x1 + ( + (msq))*x0;
  Id dFd2(x0?,x1?,x2?,eps?) =  + (msq - t);
  Id U(x0?,x1?,x2?,eps?) =  + ( + (1))*x0 + ( + (1))*x0*x1 + ( + (1))*x2 + ( + (1));
...
#define integrandContainerInitializer "{-1,0,{{5,\{-1\},sector_5_order_n1_numIV,sector_5_order_n1_integrand,#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_5_order_n1_integrand,#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#sector_5_order_n1_contour_deformation_polynomial,sector_5_order_n1_maximal_allowed_deformation_parameters},{5,\{0\},sector_5_order_0_numIV,sector_5_order_0_integrand,#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_5_order_0_integrand,#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#sector_5_order_0_contour_deformation_polynomial,sector_5_order_0_maximal_allowed_deformation_parameters}},true,#@SecDecInternalDblquote@#eps#@SecDecInternalDblquote@#}"
