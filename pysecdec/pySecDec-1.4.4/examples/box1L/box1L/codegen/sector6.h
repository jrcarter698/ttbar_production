...
#procedure insertDecomposed
  ...
  Id F(x0?,x1?,x2?,eps?) =  + ( + (-s))*x2 + ( + (msq - s1))*x0*x2 + ( + (msq - t))*x1 + ( + (msq)) + ( + (msq))*x0;
  Id dFd2(x0?,x1?,x2?,eps?) =  + (-s) + (msq - s1)*x0;
  Id U(x0?,x1?,x2?,eps?) =  + ( + (1))*x0 + ( + (1)) + ( + (1))*x1 + ( + (1))*x0*x2;
  Id ddFd0d0(x0?,x1?,x2?,eps?) =  + (0);
  Id ddFd0d1(x0?,x1?,x2?,eps?) =  + (0);
  Id ddFd1d1(x0?,x1?,x2?,eps?) =  + (0);
  Id dFd0(x0?,x1?,x2?,eps?) =  + (msq) + (msq - s1)*x2;
  Id ddFd0d2(x0?,x1?,x2?,eps?) =  + (msq - s1);
...
#define integrandContainerInitializer "{-1,0,{{6,\{-1\},sector_6_order_n1_numIV,sector_6_order_n1_integrand,#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_6_order_n1_integrand,#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#sector_6_order_n1_contour_deformation_polynomial,sector_6_order_n1_maximal_allowed_deformation_parameters},{6,\{0\},sector_6_order_0_numIV,sector_6_order_0_integrand,#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_6_order_0_integrand,#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#sector_6_order_0_contour_deformation_polynomial,sector_6_order_0_maximal_allowed_deformation_parameters}},true,#@SecDecInternalDblquote@#eps#@SecDecInternalDblquote@#}"
