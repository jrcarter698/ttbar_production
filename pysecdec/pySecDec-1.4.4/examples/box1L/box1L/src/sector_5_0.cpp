...
integrand_return_t SecDecInternalSecondAbbreviation[sector_5_order_0_optimmaxvar_second + 1];

SecDecInternalAbbreviation[1]=x1 + 1.E+0;SecDecInternalAbbreviation[1]=msq*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[2]=t - msq;SecDecInternalAbbreviation[3]=x0*msq;SecDecInternalAbbreviation[3]=SecDecInternalAbbreviation[3] - s;SecDecInternalAbbreviation[4]= - x2*SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[5]=s*x1;SecDecInternalAbbreviation[6]=s1 - msq;SecDecInternalAbbreviation[4]= - SecDecInternalAbbreviation[4] +SecDecInternalAbbreviation[5] + SecDecInternalAbbreviation[6];SecDecInternalAbbreviation[5]=x0*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[5]=SecDecInternalAbbreviation[5] -SecDecInternalAbbreviation[4];SecDecInternalAbbreviation[7]=x0*SecDecInternalLambda0;SecDecInternalAbbreviation[8]= - SecDecInternalLambda0 +SecDecInternalAbbreviation[7];SecDecInternalAbbreviation[9]= - 1.E+0 + 2.E+0*x2;SecDecInternalAbbreviation[9]=SecDecInternalAbbreviation[9]*SecDecInternalLambda2;SecDecInternalAbbreviation[10]= - 1.E+0 + 2.E+0*x1;SecDecInternalAbbreviation[10]=SecDecInternalAbbreviation[10]*SecDecInternalLambda1;SecDecInternalAbbreviation[11]=SecDecInternalLambda1*x1;SecDecInternalAbbreviation[12]= - SecDecInternalLambda0 + 2.E+0*SecDecInternalAbbreviation[7];SecDecInternalAbbreviation[13]=SecDecInternalLambda2*x2;



// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations2(3);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations2(4);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations2(5);SecDecInternalSecondAbbreviation[4]=SecDecInternalAbbreviations2(2);SecDecInternalSecondAbbreviation[5]=SecDecInternalAbbreviations2(1);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations2(7);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations2(11);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations2(10);SecDecInternalSecondAbbreviation[4]=i_*SecDecInternalSecDecInternalRealPartCall2;SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalPowCall1*SecDecInternalLambda0;SecDecInternalSecondAbbreviation[5]=SecDecInternalSecondAbbreviation[5] - SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecondAbbreviation[5]*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[6]=SecDecInternalSecDecInternalPowCall2*SecDecInternalLambda1;SecDecInternalSecondAbbreviation[6]=SecDecInternalSecondAbbreviation[6] - SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[7]=i_*SecDecInternalSecDecInternalRealPartCall1;SecDecInternalSecondAbbreviation[8]=SecDecInternalSecondAbbreviation[6]*SecDecInternalSecondAbbreviation[7];SecDecInternalSecondAbbreviation[8]=x1 + SecDecInternalSecondAbbreviation[8];SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[6]*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[6]=SecDecInternalSecondAbbreviation[3]*SecDecInternalSecondAbbreviation[7];SecDecInternalSecondAbbreviation[6]=1.E+0 + SecDecInternalSecondAbbreviation[6];

auto SecDecInternaldSecDecInternalDeformedx0d1Call1 =SecDecInternalSecondAbbreviation[5];
auto SecDecInternalSecDecInternalDeformedx1Call1 =SecDecInternalSecondAbbreviation[8];
auto SecDecInternaldSecDecInternalDeformedx1d0Call1 =SecDecInternalSecondAbbreviation[4];
...
auto SecDecInternaldSecDecInternalDeformedx2d2Call2 =SecDecInternalSecondAbbreviation[15];


// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations2(2);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations2(6);SecDecInternalSecondAbbreviation[3]= - SecDecInternalSecDecInternalDeformedx2Call1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[4]= - SecDecInternalSecDecInternalDeformedx1Call1*s;SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[4] - SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[4]= - SecDecInternalSecDecInternalDeformedx2Call2*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalDeformedx1Call2 + 1.E+0;SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalDeformedx0Call1*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[6]=msq*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[7]= - s*SecDecInternalSecDecInternalDeformedx1Call2;SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[7] + SecDecInternalSecondAbbreviation[6] - SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[6]=1.E+0 + SecDecInternalSecDecInternalDeformedx2Call1;SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalDeformedx2Call2 + 1.E+0 + SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[7]= - SecDecInternaldSecDecInternalDeformedx0d1Call1*SecDecInternaldSecDecInternalDeformedx1d0Call1;SecDecInternalSecondAbbreviation[8]=SecDecInternaldSecDecInternalDeformedx0d0Call1*SecDecInternaldSecDecInternalDeformedx1d1Call1;SecDecInternalSecondAbbreviation[7]=SecDecInternalSecondAbbreviation[7] + SecDecInternalSecondAbbreviation[8];SecDecInternalSecondAbbreviation[7]=SecDecInternaldSecDecInternalDeformedx2d2Call1*SecDecInternalSecondAbbreviation[7];SecDecInternalSecondAbbreviation[8]=SecDecInternaldSecDecInternalDeformedx0d0Call2*SecDecInternaldSecDecInternalDeformedx1d1Call2*SecDecInternaldSecDecInternalDeformedx2d2Call2;
...
SecDecInternalSecondAbbreviation[1]=SecDecInternalFCall1 -SecDecInternalFCall3;SecDecInternalSecondAbbreviation[2]=SecDecInternalFCall2 -SecDecInternalFCall4;SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalDenominatorCall1*SecDecInternalSecDecInternalDenominatorCall5*SecDecInternalSecDecInternalDenominatorCall4*SecDecInternalSecDecInternalCondefJacCall1;SecDecInternalSecondAbbreviation[4]= - SecDecInternalSecDecInternalDenominatorCall1 - 2.E+0*SecDecInternallogCall3 +SecDecInternallogCall1 + SecDecInternallogCall2;SecDecInternalSecondAbbreviation[4]=SecDecInternalSecDecInternalDenominatorCall3*SecDecInternalSecDecInternalDenominatorCall2*SecDecInternalSecDecInternalCondefJacCall2*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[4];
