...
SecDecInternalAbbreviation[1]= - x0*msq;SecDecInternalAbbreviation[2]=s*x0;SecDecInternalAbbreviation[3]=SecDecInternalAbbreviation[2]*x2;SecDecInternalAbbreviation[1]=SecDecInternalAbbreviation[1] +SecDecInternalAbbreviation[3];SecDecInternalAbbreviation[3]=x0 - 1.E+0;SecDecInternalAbbreviation[1]=SecDecInternalAbbreviation[3]*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[3]= - msq + t;SecDecInternalAbbreviation[4]=x1 - 1.E+0;SecDecInternalAbbreviation[3]=x1*SecDecInternalAbbreviation[4]*SecDecInternalAbbreviation[3];SecDecInternalAbbreviation[2]=s1 - msq +SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[4]=x2 - 1.E+0;SecDecInternalAbbreviation[2]=SecDecInternalAbbreviation[4]*x2*SecDecInternalAbbreviation[2];
