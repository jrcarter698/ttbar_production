#ifndef box1L_src_SecDecInternalFunctions_hpp_included
#define box1L_src_SecDecInternalFunctions_hpp_included
...
namespace box1L
{
    ...
    #define box1L_has_complex_parameters 0
    #define box1L_enforce_complex_return_type 0
    #if box1L_has_complex_parameters || box1L_contour_deformation || box1L_enforce_complex_return_type
      #ifdef SECDEC_WITH_CUDA
        __host__ __device__
      #endif
        ...
        inline real_t log(real_t arg)
        {
            if (arg < 0)
            {
                    ...
                    error_message += "Encountered \"log(<negative real>)\" in a real-valued integrand function of \"box1L\". ";
    ...
    complex_t inline pow(complex_t x, int y)
    {
        ...
        inline real_t pow(real_t base, real_t exponent)
        {
            if (base < 0)
            {
                    ...
                    error_message += "\"box1L\". Try to enforce complex return values for the generated integrands; i.e. set ";
                    error_message += "\"enforce_complex=True\" in the corresponding call to \"loop_package\" or \"make_package\".";
                    throw std::domain_error(error_message);
                #endif
            }
    ...
    #undef box1L_has_complex_parameters
    #undef box1L_enforce_complex_return_type
