...
SecDecInternalAbbreviation[1]=s1 - msq;SecDecInternalAbbreviation[2]= - x0*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[2]= - s + SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[3]= - x2*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[3]=msq + SecDecInternalAbbreviation[3];SecDecInternalAbbreviation[4]=t - msq;SecDecInternalAbbreviation[5]= - 1.E+0 + x2;SecDecInternalAbbreviation[5]=SecDecInternalLambda2*x2*SecDecInternalAbbreviation[5];SecDecInternalAbbreviation[6]= - 1.E+0 + x0;SecDecInternalAbbreviation[6]=SecDecInternalLambda0*x0*SecDecInternalAbbreviation[6];SecDecInternalAbbreviation[7]= - 1.E+0 + x1;SecDecInternalAbbreviation[7]=SecDecInternalLambda1*x1*SecDecInternalAbbreviation[7];
...
complex_t SecDecInternalSecDecInternalDeformedx2Call = x2 + i_*SecDecInternalSecDecInternalRealPartCall3*SecDecInternalAbbreviation[5];
tmp =  - SecDecInternalSecDecInternalDeformedx1Call*SecDecInternalAbbreviation[4] - SecDecInternalSecDecInternalDeformedx0Call*SecDecInternalSecDecInternalDeformedx2Call*SecDecInternalAbbreviation[1] + msq + msq*SecDecInternalSecDecInternalDeformedx0Call - s*SecDecInternalSecDecInternalDeformedx2Call;return tmp;
#undef x0
#undef x1
#undef x2
#undef s
