...
integrand_return_t SecDecInternalSecondAbbreviation[sector_5_order_n1_optimmaxvar_second + 1];

SecDecInternalAbbreviation[1]=1.E+0 + x1;SecDecInternalAbbreviation[1]=msq*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[2]=t - msq;SecDecInternalAbbreviation[3]= - x2*SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[4]=s1 - msq;SecDecInternalAbbreviation[5]= - s*x1;SecDecInternalAbbreviation[3]=SecDecInternalAbbreviation[5] -SecDecInternalAbbreviation[4] + SecDecInternalAbbreviation[3];SecDecInternalAbbreviation[5]= - 1.E+0 + 2.E+0*x2;SecDecInternalAbbreviation[5]=SecDecInternalLambda2*SecDecInternalAbbreviation[5];SecDecInternalAbbreviation[6]= - 1.E+0 + 2.E+0*x1;SecDecInternalAbbreviation[6]=SecDecInternalLambda1*SecDecInternalAbbreviation[6];SecDecInternalAbbreviation[7]= - SecDecInternalLambda2*x2;SecDecInternalAbbreviation[8]= - SecDecInternalLambda1*x1;



// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations1(3);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations1(2);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations1(2);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations1(4);SecDecInternalSecondAbbreviation[3]= - SecDecInternalSecondAbbreviation[1]*SecDecInternalSecDecInternalDeformedx2Call1;SecDecInternalSecondAbbreviation[4]= - s*SecDecInternalSecDecInternalDeformedx1Call1;SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[4] + SecDecInternalSecondAbbreviation[3] - SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[4]=1.E+0 + SecDecInternalSecDecInternalDeformedx2Call1;SecDecInternalSecondAbbreviation[5]=SecDecInternaldSecDecInternalDeformedx1d1Call1*SecDecInternaldSecDecInternalDeformedx2d2Call1;
