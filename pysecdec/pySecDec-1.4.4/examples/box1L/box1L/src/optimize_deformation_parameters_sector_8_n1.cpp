...
namespace box1L
{
void sector_8_order_n1_maximal_allowed_deformation_parameters
(
...
SecDecInternalAbbreviation[1]=x2 + x1;SecDecInternalAbbreviation[1]=SecDecInternalAbbreviation[1]*msq;SecDecInternalAbbreviation[2]=x2*s1;SecDecInternalAbbreviation[1]=SecDecInternalAbbreviation[1] -SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[3]= - x0 + 1.E+0;SecDecInternalAbbreviation[1]=x0*SecDecInternalAbbreviation[1]*SecDecInternalAbbreviation[3];SecDecInternalAbbreviation[3]= - 1.E+0 - x0;SecDecInternalAbbreviation[4]=x1 - 1.E+0;SecDecInternalAbbreviation[3]=SecDecInternalAbbreviation[4]*SecDecInternalAbbreviation[3]*msq*x1;SecDecInternalAbbreviation[4]=x2 - 1.E+0;SecDecInternalAbbreviation[5]= - msq*SecDecInternalAbbreviation[4];SecDecInternalAbbreviation[2]=SecDecInternalAbbreviation[5] - s1 +SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[2]=x0*SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[4]=s*SecDecInternalAbbreviation[4];SecDecInternalAbbreviation[2]=SecDecInternalAbbreviation[4] +SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[2]=x2*SecDecInternalAbbreviation[2];
