#ifndef box1L_codegen_sector_7_n1_hpp_included
#define box1L_codegen_sector_7_n1_hpp_included
#include "box1L.hpp"
#include "functions.hpp"
#include "contour_deformation_sector_7_n1.hpp"
#define sector_7_order_n1_optimmaxvar_second 8
namespace box1L
{
