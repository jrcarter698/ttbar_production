...
namespace box1L
{
void sector_4_order_n2_maximal_allowed_deformation_parameters
(
...
SecDecInternalAbbreviation[1]= - x0 + 1.E+0;SecDecInternalAbbreviation[2]=msq - t;SecDecInternalAbbreviation[1]=x0*SecDecInternalAbbreviation[2]*SecDecInternalAbbreviation[1];
