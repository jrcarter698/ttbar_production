...
complex_t SecDecInternalAbbreviation[2 + 1];
SecDecInternalAbbreviation[1]= - x1 + 1.E+0;SecDecInternalAbbreviation[2]=msq - t;SecDecInternalAbbreviation[1]=x1*SecDecInternalAbbreviation[2]*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[2]= - 1.E+0 + x2;SecDecInternalAbbreviation[2]=s*x2*SecDecInternalAbbreviation[2];
