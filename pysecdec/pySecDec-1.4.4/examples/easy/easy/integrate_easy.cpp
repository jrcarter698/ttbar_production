...
int main()
{
    ...
    const std::vector<easy::nested_series_t<easy::integrand_t>> sector_integrands = easy::make_integrands(real_parameters, complex_parameters);

    // Add integrands of sectors (together flag)
    const easy::nested_series_t<easy::integrand_t> all_sectors = std::accumulate(++sector_integrands.begin(), sector_integrands.end(), *sector_integrands.begin());

    // Integrate
    secdecutil::cuba::Vegas<easy::integrand_return_t> integrator;
