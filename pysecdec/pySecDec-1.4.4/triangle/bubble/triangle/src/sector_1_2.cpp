...
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations4(2);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations4(3);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations4(1);
...
SecDecInternalSecondAbbreviation[1]=2.E+0*SecDecInternallogCall1;SecDecInternalSecondAbbreviation[2]=SecDecInternallogCall2 - 2.E+0*SecDecInternallogCall3;SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalPowCall1 + SecDecInternalSecDecInternalPowCall2;SecDecInternalSecondAbbreviation[4]=4.E+0*SecDecInternalSecDecInternalPowCall3;SecDecInternalSecondAbbreviation[5]=4.E+0*SecDecInternallogCall2;SecDecInternalSecondAbbreviation[6]= - SecDecInternallogCall3*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[6] + SecDecInternalSecondAbbreviation[4] + SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[6]=SecDecInternalSecDecInternalDenominatorCall3*SecDecInternalSecDecInternalCondefJacCall2;SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecondAbbreviation[6];SecDecInternalSecondAbbreviation[7]=2.E+0*SecDecInternallogCall4 -SecDecInternallogCall2;SecDecInternalSecondAbbreviation[1]=SecDecInternalSecondAbbreviation[7]*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[5]=SecDecInternallogCall4*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[1]=SecDecInternalSecondAbbreviation[1] + SecDecInternalSecondAbbreviation[5] - 4.E+0*SecDecInternalSecDecInternalPowCall4 - SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[1]=SecDecInternalSecDecInternalDenominatorCall4*SecDecInternalSecDecInternalCondefJacCall1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[1]=SecDecInternalSecondAbbreviation[1] + SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[1]=SecDecInternalSecDecInternalDenominatorCall1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[2]=1.3333333333333333333E+0*SecDecInternalSecDecInternalPowCall3 + SecDecInternalSecDecInternalPowCall1;SecDecInternalSecondAbbreviation[2]=SecDecInternallogCall3*SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[3]= - SecDecInternalSecondAbbreviation[4] - 3.3333333333333333333E-1*SecDecInternalSecDecInternalPowCall1;SecDecInternalSecondAbbreviation[3]=SecDecInternallogCall1*SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[2]=2.E+0*SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecondAbbreviation[6];SecDecInternalSecondAbbreviation[1]=SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[1]=2.E+0*SecDecInternalSecDecInternalDenominatorCall2*SecDecInternalSecondAbbreviation[1];
