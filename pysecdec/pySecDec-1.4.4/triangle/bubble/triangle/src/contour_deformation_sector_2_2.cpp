...
#endif
integrand_return_t sector_2_order_2_contour_deformation_polynomial
(
...
SecDecInternalAbbreviation[1]= - 1.E+0 + x2;SecDecInternalAbbreviation[1]=x2*SecDecInternalLambda1*SecDecInternalAbbreviation[1];SecDecInternalAbbreviation[2]= - 1.E+0 + x1;SecDecInternalAbbreviation[2]=x1*SecDecInternalLambda0*SecDecInternalAbbreviation[2];SecDecInternalAbbreviation[3]= - 5.E-1*s;
