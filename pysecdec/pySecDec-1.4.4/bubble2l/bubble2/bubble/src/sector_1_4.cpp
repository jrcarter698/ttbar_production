...
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations5(3);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations5(1);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations5(2);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations5(7);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations5(5);SecDecInternalSecondAbbreviation[4]=SecDecInternalSecDecInternalPowCall6 + SecDecInternalSecDecInternalPowCall5;SecDecInternalSecondAbbreviation[4]=m2*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[1] + SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalRealPartCall1*i_;SecDecInternalSecondAbbreviation[6]=SecDecInternalSecDecInternalPowCall5*SecDecInternalLambda0;SecDecInternalSecondAbbreviation[6]= - SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[6];SecDecInternalSecondAbbreviation[6]=SecDecInternalSecondAbbreviation[6]*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[7]=SecDecInternalSecDecInternalPowCall6*SecDecInternalLambda1;SecDecInternalSecondAbbreviation[7]= - SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[7];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecondAbbreviation[7]*SecDecInternalSecondAbbreviation[5];
...
auto SecDecInternalSecDecInternalPowCall7 =pow(SecDecInternalSecDecInternalDeformedx0Call1,2);
auto SecDecInternalSecDecInternalPowCall8 =pow(SecDecInternalSecDecInternalDeformedx1Call1,2);
auto SecDecInternalSecDecInternalCondefJacCall1 =SecDecInternalSecondAbbreviation[2];


// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations5(1);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations5(4);SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalDeformedx1Call1*SecDecInternalSecDecInternalDeformedx0Call1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[4]=SecDecInternalSecDecInternalDeformedx0Call1 + SecDecInternalSecDecInternalDeformedx1Call1;SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalPowCall8 + 1.E+0 + SecDecInternalSecDecInternalPowCall7;SecDecInternalSecondAbbreviation[5]=m2*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[5] + SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[4];
...
SecDecInternalSecondAbbreviation[1]=SecDecInternalFCall1 -SecDecInternalFCall2;SecDecInternalSecondAbbreviation[2]=SecDecInternallogCall2*SecDecInternallogCall1;SecDecInternalSecondAbbreviation[3]= - SecDecInternalSecDecInternalPowCall3*SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[3] + 2.E+0*SecDecInternalSecDecInternalPowCall1 + 1.25E-1*SecDecInternalSecDecInternalPowCall2;SecDecInternalSecondAbbreviation[2]= - 1.3333333333333333333E+0*SecDecInternalSecondAbbreviation[2] + SecDecInternalSecDecInternalPowCall3;SecDecInternalSecondAbbreviation[2]=SecDecInternalSecDecInternalPowCall4*SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[2]=3.3333333333333333333E-1*SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[2]=SecDecInternalSecDecInternalDenominatorCall2*SecDecInternalSecDecInternalDenominatorCall1*SecDecInternalSecDecInternalCondefJacCall1*SecDecInternalSecondAbbreviation[2];
