...
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations4(6);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations4(3);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations4(5);SecDecInternalSecondAbbreviation[4]=SecDecInternalAbbreviations4(1);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations4(1);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations4(6);SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalDeformedx0Call1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[4]=1.E+0 + SecDecInternalSecDecInternalDeformedx0Call1;SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecDecInternalDeformedx1Call1*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalPowCall6 + 1.E+0 + SecDecInternalSecDecInternalPowCall5;SecDecInternalSecondAbbreviation[5]=m2*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[5] + SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[4];
...
SecDecInternalSecondAbbreviation[1]=SecDecInternalFCall1 -SecDecInternalFCall2;SecDecInternalSecondAbbreviation[2]= - 3.3333333333333333333E-1*SecDecInternallogCall1 + 2.E+0*SecDecInternallogCall2;SecDecInternalSecondAbbreviation[2]=SecDecInternalSecDecInternalPowCall1*SecDecInternalSecondAbbreviation[2];SecDecInternalSecondAbbreviation[3]= - SecDecInternallogCall1 +6.6666666666666666666E-1*SecDecInternallogCall2;SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalPowCall2*SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2] + 4.E+0*SecDecInternalSecondAbbreviation[3];SecDecInternalSecondAbbreviation[2]=SecDecInternalSecDecInternalDenominatorCall2*SecDecInternalSecDecInternalDenominatorCall1*SecDecInternalSecDecInternalCondefJacCall1*SecDecInternalSecondAbbreviation[2];
