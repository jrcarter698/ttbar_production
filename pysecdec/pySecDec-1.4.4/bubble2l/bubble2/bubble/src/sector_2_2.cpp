...
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations3(6);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations3(3);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations3(5);SecDecInternalSecondAbbreviation[4]=SecDecInternalAbbreviations3(1);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalSecDecInternalDeformedx0Call1 + 1.E+0 + SecDecInternalSecDecInternalDeformedx1Call1;SecDecInternalSecondAbbreviation[2]= - SecDecInternaldSecDecInternalDeformedx0d1Call1*SecDecInternaldSecDecInternalDeformedx1d0Call1;SecDecInternalSecondAbbreviation[3]=SecDecInternaldSecDecInternalDeformedx0d0Call1*SecDecInternaldSecDecInternalDeformedx1d1Call1;SecDecInternalSecondAbbreviation[2]=SecDecInternalSecondAbbreviation[2] + SecDecInternalSecondAbbreviation[3];
