...
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations5(6);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations5(3);SecDecInternalSecondAbbreviation[3]=SecDecInternalAbbreviations5(5);SecDecInternalSecondAbbreviation[4]=SecDecInternalAbbreviations5(1);
...
// begin next dependency level
SecDecInternalSecondAbbreviation[1]=SecDecInternalAbbreviations5(1);SecDecInternalSecondAbbreviation[2]=SecDecInternalAbbreviations5(6);SecDecInternalSecondAbbreviation[3]=SecDecInternalSecDecInternalDeformedx0Call1*SecDecInternalSecondAbbreviation[1];SecDecInternalSecondAbbreviation[4]=1.E+0 + SecDecInternalSecDecInternalDeformedx0Call1;SecDecInternalSecondAbbreviation[4]=SecDecInternalSecondAbbreviation[2]*SecDecInternalSecDecInternalDeformedx1Call1*SecDecInternalSecondAbbreviation[4];SecDecInternalSecondAbbreviation[5]=SecDecInternalSecDecInternalPowCall8 + 1.E+0 + SecDecInternalSecDecInternalPowCall7;SecDecInternalSecondAbbreviation[5]=m2*SecDecInternalSecondAbbreviation[5];SecDecInternalSecondAbbreviation[3]=SecDecInternalSecondAbbreviation[5] + SecDecInternalSecondAbbreviation[3] + SecDecInternalSecondAbbreviation[4];
