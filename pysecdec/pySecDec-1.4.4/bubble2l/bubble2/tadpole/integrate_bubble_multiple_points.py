...
# load c++ library
bubble = IntegralLibrary('tadpole2l/tadpole2l_pylink.so')
...
with open('kinematics.input') as f:
    for line in f:
            ...
            str_integral_with_prefactor = str_integral_with_prefactor.replace(',','*1+I*')
            str_prefactor = str_prefactor.replace(',','*1+I*')
            str_integral_without_prefactor = str_integral_without_prefactor.replace(',','*1+I*')
