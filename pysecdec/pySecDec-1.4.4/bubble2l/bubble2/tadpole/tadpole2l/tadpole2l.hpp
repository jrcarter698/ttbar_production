#ifndef tadpole2l_hpp_included
#define tadpole2l_hpp_included
...
namespace tadpole2l
{
    ...
    const std::vector<int> highest_orders = {5}; // not including the prefactor
    const std::vector<int> lowest_prefactor_orders = {-1};
    const std::vector<int> highest_prefactor_orders = {5};
