...
#define INTEGRAL_NAME tadpole2l
#define tadpole2l_number_of_sectors 1
    ...
    #define INSTANTIATE_KOROBOV_QMC_SEPARATE(KOROBOVDEGREE1,KOROBOVDEGREE2) \
        ...
        template class secdecutil::integrators::Qmc< \
                                                   ...
                                                   >;
#if tadpole2l_number_of_sectors != 1
    ...
    #define INSTANTIATE_KOROBOV_QMC(KOROBOVDEGREE1,KOROBOVDEGREE2) \
        ...
        template class secdecutil::integrators::Qmc< \
                                                    ...
                                                    >;
#endif
INSTANTIATE_KOROBOV_QMC(4,1) INSTANTIATE_KOROBOV_QMC(4,2) INSTANTIATE_KOROBOV_QMC(4,3) INSTANTIATE_KOROBOV_QMC(4,4) INSTANTIATE_KOROBOV_QMC(4,5) INSTANTIATE_KOROBOV_QMC(4,6)
#undef INSTANTIATE_KOROBOV_QMC_SEPARATE
#undef INSTANTIATE_KOROBOV_QMC
#undef tadpole2l_number_of_sectors
