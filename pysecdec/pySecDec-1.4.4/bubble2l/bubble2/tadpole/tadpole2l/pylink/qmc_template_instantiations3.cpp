...
#define tadpole2l_number_of_sectors 1
    ...
    #define INSTANTIATE_KOROBOV_QMC(KOROBOVDEGREE1,KOROBOVDEGREE2) \
        ...
        template class secdecutil::integrators::Qmc< \
                                                    ...
                                                    >;
#endif
INSTANTIATE_KOROBOV_QMC(3,1) INSTANTIATE_KOROBOV_QMC(3,2) INSTANTIATE_KOROBOV_QMC(3,3) INSTANTIATE_KOROBOV_QMC(3,4) INSTANTIATE_KOROBOV_QMC(3,5) INSTANTIATE_KOROBOV_QMC(3,6)
