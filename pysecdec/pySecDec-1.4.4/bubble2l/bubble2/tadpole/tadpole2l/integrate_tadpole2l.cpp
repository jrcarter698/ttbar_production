...
int main()
{
    ...
    const std::vector<tadpole2l::nested_series_t<tadpole2l::integrand_t>> sector_integrands = tadpole2l::make_integrands(real_parameters, complex_parameters);

    // Add integrands of sectors (together flag)
    const tadpole2l::nested_series_t<tadpole2l::integrand_t> all_sectors = std::accumulate(++sector_integrands.begin(), sector_integrands.end(), *sector_integrands.begin());

    // Integrate
    secdecutil::cuba::Vegas<tadpole2l::integrand_return_t> integrator;
