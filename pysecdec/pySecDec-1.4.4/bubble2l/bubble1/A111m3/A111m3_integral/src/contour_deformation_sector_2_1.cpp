...
)
{
    ...
    return(__Deformedx1Call*tmp1_4 + __Deformedx0Call*tmp1_4 + m2 + m2*__Deformedx1Call*__Deformedx1Call + m2*__Deformedx0Call*__Deformedx1Call + m2*__Deformedx0Call*__Deformedx0Call);
}
}
