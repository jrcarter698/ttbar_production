...
#procedure insertOther
  ...
  Id SecDecInternalOtherPoly0(x0?,x1?,eps?) =  + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (8)))*eps^3 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-60)))*eps^2 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (148)))*eps + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-120))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-12*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*eps^3 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (78*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*eps^2 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-168*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*eps + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (120*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (6*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*eps^3 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-30*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*eps^2 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (48*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*eps + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-24*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2)))) + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-m2^3)))*eps^3 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (3*m2^3)))*eps^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-2*m2^3)))*eps + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-12*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*x0*eps^3 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (78*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*x0*eps^2 + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-168*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*x0*eps + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (120*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)))*x0 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (12*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0*eps^3 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-60*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0*eps^2 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (96*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0*eps + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-48*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-3*m2^3)))*x0*eps^3 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (9*m2^3)))*x0*eps^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-6*m2^3)))*x0*eps + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (6*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0^2*eps^3 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-30*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0^2*eps^2 + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (48*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0^2*eps + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-24*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))))*x0^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-3*m2^3)))*x0^2*eps^3 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (9*m2^3)))*x0^2*eps^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-6*m2^3)))*x0^2*eps + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-m2^3)))*x0^3*eps^3 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (3*m2^3)))*x0^3*eps^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-2*m2^3)))*x0^3*eps;
  Id dSecDecInternalOtherPoly0d2(x0?,x1?,eps?) =  + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-2*m2^3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (48*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2)))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-168*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (148)))) + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (3*m2^3)) * ( + (2))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-30*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (2))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (78*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (2))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-60)) * ( + (2))))*eps + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-m2^3)) * ( + (3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (6*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (3))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-12*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (3))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (8)) * ( + (3))))*eps^2 + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-6*m2^3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (96*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2)))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-168*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps))))*x0 + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (9*m2^3)) * ( + (2))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-60*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (2))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (78*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (2))))*x0*eps + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-3*m2^3)) * ( + (3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (12*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (3))) + (((F( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (-12*m2)) * (U( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (3))))*x0*eps^2 + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-6*m2^3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (48*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2)))))*x0^2 + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (9*m2^3)) * ( + (2))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (-30*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (2))))*x0^2*eps + ((((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-3*m2^3)) * ( + (3))) + ((F( + (1)*x0, + (1)*x1, + (1)*eps)) * ( + (6*m2^2)) * ((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (2))) * ( + (3))))*x0^2*eps^2 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-2*m2^3)))*x0^3 + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (3*m2^3)) * ( + (2)))*x0^3*eps + (((U( + (1)*x0, + (1)*x1, + (1)*eps)) ^ ( + (3))) * ( + (-m2^3)) * ( + (3)))*x0^3*eps^2;
...
#procedure insertDecomposed
  ...
  Id F(x0?,x1?,eps?) =  + ( + (m2)) + ( + (m2))*x1 + ( + (m2))*x1^2 + ( + (2*m2))*x0 + ( + (2*m2))*x0*x1 + ( + (m2))*x0^2;
