...
extern "C" int
A111m3_integral__sector_1_order_0(
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto tmp3_34 = 1 + tmp3_15;
        auto tmp3_35 = tmp3_4*__PowCall6*tmp3_25*tmp3_34;
        auto tmp3_36 = -2*tmp3_15-1-__PowCall4;
        auto tmp3_37 = __PowCall8*__PowCall3*tmp3_33*tmp3_36;
        auto tmp3_38 = 2.4E+1*tmp3_37-1.2E+2*__PowCall7 + tmp3_35;
        auto tmp3_39 = __PowCall10*__PowCall9;
        auto __DenominatorCall2 = SecDecInternalDenominator(tmp3_39);
        auto tmp3_40 = -tmp3_6 + tmp3_33;
        auto tmp3_41 = tmp3_28*tmp3_38*__DenominatorCall1*__DenominatorCall2;
        ...
        auto tmp3_42 = SecDecInternalRealPart(tmp3_25);
        if (unlikely(tmp3_42<0)) SecDecInternalSignCheckErrorPositivePolynomial(1);
        acc = acc + w*(tmp3_41);
    }
...
extern "C" void
A111m3_integral__sector_1_order_0__maxdeformp(
...
extern "C" int
A111m3_integral__sector_1_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
