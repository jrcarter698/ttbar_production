...
# load c++ library
A111m3 = IntegralLibrary('A111m3/A111m3_pylink.so')
A1111 = IntegralLibrary('A1111/A1111_pylink.so')

# choose integrator
A1111.use_Vegas(flags=2) # ``flags=2``: verbose --> see Cuba manual

# integrate
str_integral_without_prefactor, str_prefactor, str_integral_with_prefactor = A1111(real_parameters=[500**2,np.pi/2*500**2,175**2])
