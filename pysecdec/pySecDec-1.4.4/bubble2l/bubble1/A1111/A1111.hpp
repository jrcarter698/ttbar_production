#ifndef A1111_hpp_included
#define A1111_hpp_included
...
namespace A1111
{
    ...
    #define A1111_contour_deformation 1
...
{
    template <>
    struct common_type<A1111::cuda_together_integrand_t, A1111::cuda_integrand_t> 
    {
        using type = A1111::cuda_together_integrand_t;
    };
}
#endif
