...
extern "C" void
A1111_integral__sector_5_order_0__maxdeformp(
...
extern "C" int
A1111_integral__sector_5_order_0__fpolycheck(
    const uint64_t lattice,
    const uint64_t index1,
    const uint64_t index2,
    const uint64_t * restrict genvec,
...
)
{
    ...
    for (; index < index2; index += 4) {
        ...
        auto fpoly_im = SecDecInternalImagPart(__Deformedx0Call*__Deformedx2Call*tmp3_10 + __Deformedx0Call*__Deformedx1Call*tmp3_10 + m2 + m2*__Deformedx2Call + m2*__Deformedx0Call + m2*__Deformedx0Call*__Deformedx2Call*__Deformedx2Call + m2*__Deformedx0Call*__Deformedx1Call*__Deformedx2Call + m2*__Deformedx0Call*__Deformedx1Call*__Deformedx1Call);
