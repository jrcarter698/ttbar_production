...
#procedure insertDecomposed
  ...
  Id dFd1(x0?,x1?,x2?,eps?) =  + (m2) + (m2)*x2;
  Id F(x0?,x1?,x2?,eps?) =  + ( + (m2))*x2^2 + ( + (m2))*x1*x2 + ( + (m2))*x0*x2 + ( + (m2))*x0^2 + ( + (2*m2))*x2 + ( + (m2))*x1 + ( + (2*m2))*x0 + ( + (m2));
  Id ddFd0d1(x0?,x1?,x2?,eps?) =  + (0);
  Id U(x0?,x1?,x2?,eps?) =  + ( + (1)) + ( + (1))*x0 + ( + (1))*x1 + ( + (1))*x2;
  Id dFd2(x0?,x1?,x2?,eps?) =  + (2*m2) + (2*m2)*x2 + (m2)*x1 + (m2)*x0;
  Id ddFd1d2(x0?,x1?,x2?,eps?) =  + (m2);
  Id dFd0(x0?,x1?,x2?,eps?) =  + (2*m2) + (m2)*x2 + (2*m2)*x0;
  Id ddFd2d2(x0?,x1?,x2?,eps?) =  + (2*m2);
  Id ddFd1d1(x0?,x1?,x2?,eps?) =  + (0);
  Id SecDecInternalDecoPoly2(x0?,x1?,x2?,eps?) =  + ( + (1));
  Id ddFd0d2(x0?,x1?,x2?,eps?) =  + (m2);
