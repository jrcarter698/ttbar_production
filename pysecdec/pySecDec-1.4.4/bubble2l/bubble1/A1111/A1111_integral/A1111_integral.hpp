#ifndef A1111_integral_hpp_included
#define A1111_integral_hpp_included
...
namespace A1111_integral
{
    ...
    #define A1111_integral_has_complex_parameters 0

    // whether or not the return type should be complex in any case
    #define A1111_integral_enforce_complex_return_type 0
    ...
    #endif
    #if A1111_integral_has_complex_parameters || A1111_integral_contour_deformation || A1111_integral_enforce_complex_return_type
    ...
    const std::string package_name = "A1111_integral";

    const unsigned long long number_of_sectors = 8;

    const unsigned int maximal_number_of_integration_variables = 3;
    ...
    //#undef A1111_integral_has_complex_parameters
    //#undef A1111_integral_enforce_complex_return_type
...
{
    template <>
    struct common_type<A1111_integral::cuda_together_integrand_t, A1111_integral::cuda_integrand_t> 
    {
        using type = A1111_integral::cuda_together_integrand_t;
    };
}
#endif
