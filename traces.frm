...
id T(i?,6)=g_(i,eps2,p1);
id T(i?,7)=g_(i,eps1,p1);
id T(i?,8)=g_(i,eps1,eps2);
id pre(1,1)=eps1.eps2;
id pre(1,2)=eps1.p2*eps2.p1;
id pre(1,3)=eps1.p2*eps2.p3;
id pre(1,4)=eps1.p3*eps2.p1;
id pre(1,5)=eps1.p3*eps2.p3;
